...
const instagramlu = 'https://www.instagram.com/rasya.gaming.5828/'; // Nama Instagramlu cok
const whatsapplu = '088-1310-0198'; // Nomor whatsapplu cok
const kapanbotaktif = 'JAM  5 PAGI - 6 SORE'; // Kapan bot lu aktif
const grupch1 = 'TIDAK ADA GRUP'; // OFFICIAL GRUP LU 1
const grupch2 = 'TIDAK ADA GRUP'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Root@DikaIsReal`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Root@DikaIsReal`)
})
